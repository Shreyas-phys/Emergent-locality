...
int main()
{
	...
	char* base = "D:\\OneDrive - Tulane University\\RESEARCH\\Quantum transport\\Code\\Plots\\B0LFIMwithLR\\Projectedband2CorrelationfunctionTest";
	...
	for (varyVariable = 100; varyVariable < 101; varyVariable += 1)
	{
		char filenameNA[256];
		char filenameA[256];
